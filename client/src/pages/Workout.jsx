...
function BrownDatePicker({ id, label, value, onChange, min }) {
  ...
  const [viewMonth, setViewMonth] = useState(selected ? selected.getUTCMonth() : today.getUTCMonth())
...
export default function Workout() {
  ...
  const [totalMinutes, setTotalMinutes] = useState(900)
  ...
  return (
    <div className="workout-page">
      <header className="workout-header" aria-label="Header">
      ...
      <main className="workout-main">
        <section className="workout-intro" aria-labelledby="workout-quote-text">
          <blockquote className="workout-quote" aria-label="Inspirational quote">
            <p id="workout-quote-text" className="workout-quote-text">“A little progress each day adds up to big results.”</p>
            <cite className="workout-quote-author">— Satya Nani</cite>
          </blockquote>
        </section>

        <section className="workout-card" role="region" aria-labelledby="plan-title">
          <h2 id="plan-title" className="plan-title">Plan setup</h2>
          <form className="workout-form" onSubmit={onSave}>
